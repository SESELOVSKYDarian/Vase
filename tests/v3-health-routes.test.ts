...
import * as appInternalHealth from "../apps/vase-app/app/api/internal/admin/health/route";
import * as appLive from "../apps/vase-app/app/api/health/live/route";
import * as appReady from "../apps/vase-app/app/api/health/ready/route";
