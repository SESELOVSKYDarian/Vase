...
1. Perfil Damac: SSID `Damac N4164`.
2. Perfil Barra: SSID `Barra`.
3. Perfil editable: SSID y contraseña entregados desde Management y guardados en `Preferences`.

El perfil editable se probará primero. Si no conecta, el ESP32 probará los dos perfiles integrados. Las credenciales recibidas por la API se almacenarán en memoria no volátil y no se devolverán en las respuestas públicas.
