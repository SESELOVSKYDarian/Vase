    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    data = (_a.sent()).data;
                    return [2 /*return*/, (data === null || data === void 0 ? void 0 : data.value) ? JSON.parse(data.value) : null];
            }
        });
    });
}
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    data = (_a.sent()).data;
                    return [2 /*return*/, (data === null || data === void 0 ? void 0 : data.value) ? JSON.parse(data.value) : 'disconnected'];
            }
        });
    });
}
