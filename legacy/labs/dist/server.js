...
app.prepare().then(function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        (0, http_1.createServer)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            // We'll implementing a custom loader for the bot that exposes the QR
            Promise.resolve().then(function () { return __importStar(require('./lib/bot-loader')); }).then(function (loader) { return loader.initBot(); });
        });
        return [2 /*return*/];
    });
}); });
