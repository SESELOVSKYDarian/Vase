export async function downloadWhatsAppMedia(mediaId: string, accessToken: string, graphVersion = "v17.0") {
  const urlResponse = await fetch(`https://graph.facebook.com/${graphVersion}/${mediaId}`, {
    headers: {
