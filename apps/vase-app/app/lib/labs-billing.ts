...
export function createLabsEntitlementProjection(input: CreateLabsProjectionInput): LabsEntitlementProjection {
  return {
    globalTenantId: input.globalTenantId,
    productKey: "labs",
    status: input.status,
...
export function createLabsTenantProvisioning(input: LabsTenantProvisioningInput) {
  return {
    company: {
